...
export default function TranslationSwitch({ translations, currentLanguage, setCurrentLanguage }) {
    ...
    const toggleLanguage = () => {
        // If we have more than one translation, simply toggle between them
        const nextLang = translations.find(t => t.language.code !== currentLanguage);
        if (nextLang) {
